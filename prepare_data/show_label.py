...
# 修改输入图片文件夹
img_folder = r"D:\datasets\images"
img_list = os.listdir(img_folder)
img_list.sort()

# 修改输入标签文件夹
label_folder = r"D:\datasets\label"
label_list = os.listdir(label_folder)
label_list.sort()

# 输出图片文件夹位置
path = os.getcwd()
output_folder = path + '/' + str("show_label")
os.mkdir(output_folder)

# 修改你的类别
labels = ["cellosilk", "black_spot", "fragment", "crack", "scratching"]  # 在此处修改你的类别
# 不同类别的颜色
colormap = [(0, 255, 0), (255, 0, 0), (0, 0, 255), (255, 125, 0), (0, 125, 255)]  # 色盘，根据类别添加颜色
